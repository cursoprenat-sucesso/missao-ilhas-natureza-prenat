(() => {
  ...
  const DEFAULT_SETTINGS = {
    slug: 'missao-ilhas-natureza-prenat-v13-final',
    brand: 'PRENAT+',
  ...
  function turtleBadgeSvg(stage = 0, mode = 'island') {
    ...
    if (s === 6) {
      return `<div class="boss-duo-icon ${mode}" role="img" aria-label="${escapeHtml(title)}"><span class="boss-trophy">🏆</span><span class="boss-shark">🦈</span></div>`;
    }
      ...
      `
        ...
        <g transform="translate(90 76)">
          <g transform="translate(-22 2)">
            <path d="M-13 -22 h26 v18 c0 13 -9 22 -13 24 c-4 -2 -13 -11 -13 -24 z" fill="#fccc46" stroke="#6d5b2e" stroke-width="3.6"/>
            <path d="M-13 -15 h-10 c0 10 7 17 15 17 M13 -15 h10 c0 10 -7 17 -15 17" fill="none" stroke="#6d5b2e" stroke-width="3.6" stroke-linecap="round"/>
            <path d="M0 20 v10 M-14 30 h28" stroke="#6d5b2e" stroke-width="3.6" stroke-linecap="round"/>
            <circle cx="0" cy="-7" r="4" fill="#fff3bd" opacity=".85"/>
          </g>
          <g transform="translate(24 -2)">
            <path d="M-20 16 C-10 1 4 -10 24 -21 C31 -3 29 15 19 28 C12 21 4 18 -6 20 Z" fill="#607986" stroke="#314b57" stroke-width="4" stroke-linejoin="round"/>
            <path d="M8 -5 C14 -2 19 2 23 9" fill="none" stroke="#d7f7f7" stroke-width="3" stroke-linecap="round"/>
            <circle cx="18" cy="-2" r="2.6" fill="#17242b"/>
          </g>
          <path d="M-37 -28 L-29 -39 L-20 -28" fill="none" stroke="#d01890" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M7 35 q20 10 42 1" fill="none" stroke="#09999f" stroke-width="3" stroke-linecap="round" opacity=".55"/>
        </g>
      `
    ];
